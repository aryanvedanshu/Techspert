  ...
  useEffect(() => {
    const fetchContactInfo = async () => {
      ...
      try {
        ...
        const contactArray = Array.isArray(contactData) ? contactData : (contactData ? [contactData] : [])
        logger.apiResponse('GET', '/contact-info', response.status, { count: contactArray.length }, Date.now() - startTime)
