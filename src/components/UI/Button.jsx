...
const Button = forwardRef(({
  ...
  const variants = {
    primary: 'bg-primary-600 hover:bg-primary-700 text-white shadow-medium hover:shadow-large hover:-translate-y-0.5 focus:ring-primary-200',
    ...
    danger: 'bg-red-600 hover:bg-red-700 text-white shadow-medium hover:shadow-large hover:-translate-y-0.5 focus:ring-red-200',
  }
